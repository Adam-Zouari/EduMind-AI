...
class ExtractionResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        RAG expects a flat structure with:
        - 'text' field (required)
        - 'source' field (recommended) - maps from file_path
        - All metadata fields at top level (flattened)

        Returns:
            Dictionary compatible with RAG pipeline
        """
